...
hidroweb_downloader <- function(stns = c("17200000", "77140000", "75550000", "74500000")
                                ,options = c("Chuva", "Cota")
                                ,dest.dir = "../zips/"){
...
# ## carregar diretório destino antes de carregar as funções
 dir.destino <- "/home/hidro2roilan/Dissertação/DADOS_ANA/zips/"
# print(load("anaPluInfo.rda"))
# anaPluInfo
est.all <- read.csv("~/Dissertação/DADOS_ANA/zips/cod_all_stns_ANA.txt",header = FALSE)
# ## Exemplo download
hidroweb_downloader(stns = est.all[44:55,1] %>% as.character
                    ,options = "Chuva"
                    ,dest.dir = dir.destino)
